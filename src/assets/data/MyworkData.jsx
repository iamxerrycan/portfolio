const MyworkData = [
  {
    ...
    image: 'https://i.imgur.com/9vCwYwj.png', // Example image URL, replace with your own
    description:
  ...
  },
  {
    ...
    github: 'https://github.com/iamxerrycan/user-management',
    image: 'https://i.imgur.com/9vCwYwj.png', // Example image URL, replace with your own
    description:
      'A user management system that allows for creating, reading, updating, and deleting user profiles using a RESTful API.',
    category: 'Frontend',
  },
  {
    name: 'Card-Demo',
    ...
    github: 'https://github.com/iamxerrycan/Card-Demo',
    image: 'https://i.imgur.com/9vCwYwj.png', // Example image URL, replace with your own
    description:
